<template>
  <div>
    ...
    <!-- Ícono de ubicación y texto -->
    <div class="bg-black text-indigo-400 fixed top-14 left-0 right-0 flex items-center justify-start h-10 px-2">
      <button class="flex items-center">
        <div class="bg-transparent">
          ...
          <span class="text-xs ml-1">Código postal</span>
      </button>
    </div>
  </div>

    <!-- Contenedor de fondo semitransparente -->
    <div class="overflow-y-auto overflow-x-hidden bg-gray-600/50 min-h-screen w-full fixed top-0 left-0 right-0 backdrop-blur-sm" @click="closeMenu" v-if="showMenu">
    ...
    <div class="min-h-screen w-56 fixed top-0 left-0 bg-gradient-to-r from-neutral-900 via-teal-900 to-emerald-800">
      <div>
          ...
          <button @click="closeMenu" v-if="showMenu" class="mt-5 ml-2 text-white">                               
            ...
            <div class="flex items-center text-white text-x1 hover:bg-orange-400 cursor-pointer py-3 mb-1 mt-1 ml-6 mr-4 rounded-xl" @click="ToPuntos">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <span class="text-x1 ml-6">Puntos</span>
            </div>
            <div class="flex items-center text-white text-x1 hover:bg-orange-400 cursor-pointer py-3 mb-1 mt-1 ml-6 mr-4 rounded-xl" @click="ToChat">
              ...
              <span class="text-x1 ml-6">Tiendas registradas</span>
            </div>
...
export default {
  ...
  methods: {
    ...
    ToChat() {      
      this.$router.push('/itemBar/TiendasR');
    },
    ToPuntos() {      

          ...
          <h1 class="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 mr-2">Mi Carrito</h1>
            ...
            <button class="grid grid-cols-1">
              <div v-for="(product, index) in products" :key="index" class="shadow-md relative">
                ...
                <!-- Contenido del botón -->
                <div class="flex items-center justify-center bg-zinc-400 py-6 md:py-8 lg:py-10 xl:py-12 px-4 md:px-6 lg:px-8 xl:px-10">
                  ...
                  <div class="ml-4 w-full text-right">
                    ...
                    <p class="text-black mt-4">Cantidad: (1)</p>
                  </div>
                </div>
              </div>
            </button>
  ...
  export default {
    data() {
      return {
        ...
        products: [
          { description: 'Galletas goting en forma de estrella', price: '$10.00', img:'/vexdeMarket/assets/PruebaUno.png'},
          { description: 'Bebida Going de 500ml _ energetizante', price: '$30.00', img:'/vexdeMarket/assets/drink.png'},
          { description: 'Libreta con pasta de cuero de caballo', price: '$40.00', img:'/vexdeMarket/assets/libreta.png'},
          { description: 'Mochila escolar femenina de 10 a 15 años', price: '$50.00', img:'_nuxt/assets/mochila.png'},
          { description: 'Tenis rojos GOING talla 27 cm con suela de hule', price: '$60.00', img:'/vexdeMarket/assets/tenis.png'},
          { description: 'Collar con dije en forma de corazón GOING', price: '$70.00', img:'/vexdeMarket/assets/collar.png'},
          { description: 'Hamburguesa cheveRe sencilla de una sola pieza de carne', price: '$45.00', img:'/vexdeMarket/assets/hamburguesa.png'},
          { description: '1 kilo de tortillas', price: '$12.00', img:'/vexdeMarket/assets/tortillas.png'},
          { description: 'Tarro de michelada con o sin clamato y cerveza de su preferencia', price: '$40.00', img:'/vexdeMarket/assets/michelada.png'},
        ],
